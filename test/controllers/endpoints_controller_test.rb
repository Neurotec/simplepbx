...
class EndpointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endpoint" do
    assert_difference('Endpoint.count') do
      post endpoints_url, params: { endpoint: { address: @endpoint.address, port: @endpoint.port, user_id: @endpoint.user_id } }
    end
  ...
  test "should update endpoint" do
    patch endpoint_url(@endpoint), params: { endpoint: { address: @endpoint.address, port: @endpoint.port, user_id: @endpoint.user_id } }
