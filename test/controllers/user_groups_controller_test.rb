...
class UserGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_group" do
    assert_difference('UserGroup.count') do
      post user_groups_url, params: { user_group: { group_permissions_id: @user_group.group_permissions_id, name: @user_group.name } }
    end
  ...
  test "should update user_group" do
    patch user_group_url(@user_group), params: { user_group: { group_permissions_id: @user_group.group_permissions_id, name: @user_group.name } }
